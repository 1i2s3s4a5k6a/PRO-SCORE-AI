...
MAILCHIMP_LIST_ID = os.environ.get("MAILCHIMP_LIST_ID") # Add this line
...
if not (ODDS_API_KEY and FOOTBALL_KEY and TELEGRAM_TOKEN and MAILCHIMP_API and MAILCHIMP_LIST_ID):
    st.error("One or more API keys / tokens are not set. Please update your .env file or Secrets.")
    st.stop()
